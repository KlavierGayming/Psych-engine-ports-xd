...
{
	public static var psychEngineVersion:String = '3.4.1'; //This is also used for Discord RPC
	...
	override function create()
	{
		...
		var versionShit:FlxText = new FlxText(12, FlxG.height - 44, 0, "PEDA Engine Psych 4.2 Edition v" + psychEngineVersion, 12);
